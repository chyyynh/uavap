...
function RightSidePanel({
  ...
  return (
    <div className="flex h-full flex-col gap-2">
      ...
      {/* 2. Toggle Section - Terrain/Landcover or Detail - Scrollable Middle */}
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden border border-white/[0.08] bg-black/90 backdrop-blur-md shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
        {/* Toggle Header */}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10">
          {viewMode === 'terrain' ? (
            ...
            <div className="flex flex-col">
              {/* Filter */}
              <div className="sticky top-0 z-10 flex items-center justify-between border-b border-white/[0.06] bg-black/95 px-3 py-2">
                ...
                >
                  <SelectTrigger className="h-5 w-20 gap-1 border-white/[0.08] bg-transparent px-2 text-[8px] font-medium uppercase tracking-wider text-white/60">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="border-white/[0.08] bg-black/95 backdrop-blur-md">
                    <SelectItem value="all" className="text-[9px] uppercase text-white/80">
                      All
                    </SelectItem>
                    <SelectItem value="person" className="text-[9px] uppercase text-white/80">
                      Person
                    </SelectItem>
                    <SelectItem value="vehicle" className="text-[9px] uppercase text-white/80">
                      Vehicle
                    </SelectItem>
                    <SelectItem value="cone" className="text-[9px] uppercase text-white/80">
                      Cone
                    </SelectItem>
                  </SelectContent>
                </Select>
